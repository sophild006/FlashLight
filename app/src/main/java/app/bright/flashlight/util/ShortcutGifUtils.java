...
public class ShortcutGifUtils {
    // Action 添加Shortcut
    public static final String ACTION_ADD_SHORTCUT = "com.android.launcher.action.INSTALL_SHORTCUT";
    // Action 移除Shortcut
    public static final String ACTION_REMOVE_SHORTCUT = "com.android.launcher.action.UNINSTALL_SHORTCUT";

    public static final String ShortcutName = "Slot";
    ...
    public static void addShortcut() {
        ...
        intent.putExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE, Intent.ShortcutIconResource.fromContext(context, R.mipmap.icon_gif));
    ...
    private static Uri getUriFromLauncher() {
        ...
        String authority = LauncherUtil.getAuthorityFromPermissionDefault(ShortcutGifUtils.context);
        if (authority == null || authority.trim().equals("")) {
            authority = LauncherUtil.getAuthorityFromPermission(ShortcutGifUtils.context, LauncherUtil.getCurrentLauncherPackageName(ShortcutGifUtils.context) + ".permission.READ_SETTINGS");
        }
...
//        intent.addCategory(Intent.CATEGORY_LAUNCHER);
    ...
    public static Intent getShortcutActionIntent() {
        if (shortcutActionIntent == null) {
            ...
            shortcutActionIntent.setClassName(context, GameActivity.class.getName());
            ...
            data.putInt("index", 1);
            data.putInt("type", 1);
            shortcutActionIntent.putExtra("data", data);
        }
